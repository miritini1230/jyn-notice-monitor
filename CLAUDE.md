...
- 일반 공지가 삭제돼 개수가 줄면, 캐시 윈도우(최근 5개) 밖으로 밀려나 있던 공지가 다시 최근 5개 안으로 들어오면서 🔔 거짓 "새 공지" 알림이 1회 올 수 있음 (이론이 아니라 실제 발생 확인됨 — idx 5255190 사례). 캐시가 최근 5개만 기억해서 생기는 현상으로, 핀 해제 케이스와 같은 계열.
